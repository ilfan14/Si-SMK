            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="ijudul" id="ijudul" class="form-control input-md" value="{{ $info->judul }}">
                    </div>
                </div>
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <textarea id="isiinformasi" name="isiinformasi" class="form-control input-md">{{$info->isi}}</textarea>
