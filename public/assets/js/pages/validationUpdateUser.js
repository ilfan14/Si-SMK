 function Validation() {
        ...
        var username = document.FormUpdate.iusername;
        var Name = document.FormUpdate.inama;
        var tempatlahir = document.FormUpdate.itempatlahir;
        var tgllahir = document.FormUpdate.itanggallahir;
        var Email = document.FormUpdate.iemail;
        var Address1 = document.FormUpdate.ialamat;
        var Phone = document.FormUpdate.inohp;
        ...
        var x = document.forms["FormUpdate"]["iemail"].value;
        var atpos = x.indexOf("@");
